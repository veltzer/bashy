function configure_powerline() {
	...
	if [ -x /usr/bin/clear_console ]; then
		...
		if [[ -f /usr/local/bin/powerline-daemon && -f /usr/local/lib/python3.5/dist-packages/powerline/bindings/bash/powerline.sh ]]; then
			...
			found=true
		elif [[ -f /usr/bin/powerline-daemon && -f /usr/share/powerline/bindings/bash/powerline.sh ]]; then
			...
			found=true
		elif [[ -f /usr/local/bin/powerline-daemon && -f /usr/local/lib/python2.7/dist-packages/powerline/bindings/bash/powerline.sh ]]; then
